...
<nav id="menu-h">
        ...
        <button class="listaAdmin" onclick="location.href='cadastroimagem.html'" type="button">Novo</button>
<?php
require_once 'PHP/conecta.php';

//Monta o comando de Inserção no Banco
$cmd = $pdo->query("SELECT * FROM PRODUTO_IMAGEM");
?>    
...
?>
        <tr>
            ...
            <td>
                <button class="btn btn-secondary btn-sm" a href="atualizarform.php?id=<?php echo $linha["ADM_ID"] ?>">Atualizar</button>
            </td>
            <td>
                <button class="btn btn-secondary btn-sm" a href="excluirform.php?id=<?php echo $linha["ADM_ID"] ?>">Ativar/Desativar</button>
            </td>        
        </tr>
    <?php
    } //while($linha = $cmd->fetch())
